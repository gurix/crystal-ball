...
\input{introduction}
%\section{Recherche}
%Hauptquelle der Literatur-Recherche waren Artikel, %welche via Google Scholar gefunden wurden. %Grundlagen zu den Verfahren wurden mittels %\citeA{bortz2011} und \citeA{jacob2003applied} %erarbeitet. Interessante Hinweise und praktische %Beispiele fanden sich ausserdem in den Manuals von %R.
\input{why}
